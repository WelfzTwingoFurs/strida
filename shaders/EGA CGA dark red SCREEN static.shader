...
void fragment() {
	...
	if (COLOR == c1) {COLOR = c9;}
		...
		if (int(SCREEN_UV.y/SCREEN_PIXEL_SIZE.y) % 2 == 0)
			if (int(SCREEN_UV.x/SCREEN_PIXEL_SIZE.x) % 2 == 0) {COLOR = c16;}
			else {COLOR = c12;}
			
		else
			if (int(SCREEN_UV.x/SCREEN_PIXEL_SIZE.x) % 2 == 0) {COLOR = c12;}
			else {COLOR = c16;}}
		...
		if (int(SCREEN_UV.y/SCREEN_PIXEL_SIZE.y) % 2 == 0)
			...
			if (int(SCREEN_UV.x/SCREEN_PIXEL_SIZE.x) % 2 == 0) {COLOR = c13;}
			else {COLOR = c16;}}
		...
		if (int(SCREEN_UV.y/SCREEN_PIXEL_SIZE.y) % 2 == 0)
			...
			if (int(SCREEN_UV.x/SCREEN_PIXEL_SIZE.x) % 2 == 0) {COLOR = c9;}
			else {COLOR = c12;}}
